...
class StandingService
{
    ...
    public function storeStandingsFromApi()
    {
        ...
        try {
            ...
            foreach ($names as $name) {
                ...
                ])->get("{$this->apiUrlFootball}/competitions/{$name}/standings?season=2024");
    ...
    {
        try {
            return $this->standingRepository->getStandingsByCompetitionAndSeason($competitionId, $seasonId);
        } catch (\Exception $e) {
    ...
    {
        try {
            return $this->standingRepository->getStandingsByMatchday($competitionId, $seasonId, $matchday);
        } catch (\Exception $e) {
